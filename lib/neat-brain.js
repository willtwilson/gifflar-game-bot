  ...
  const bootInterval = setInterval(() => {
    ...
    window.Phaser.Game = function (...args) {
      ...
      game.events.on('step', () => {
        ...
        const goingUp = vy < 0;
        const prevWasGoingUp = wasGoingUp; // capture before update for trampoline hit detection
        ...
        // Detect trampoline hits — use prevWasGoingUp captured before the update above
